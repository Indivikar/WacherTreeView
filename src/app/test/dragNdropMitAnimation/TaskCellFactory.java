package app.test.dragNdropMitAnimation;
...
public class TaskCellFactory implements Callback<TreeView<TaskNode>, TreeCell<TaskNode>> {
    ...
    private static final Image TASKS_IMAGE = new Image("app/test/dragNdropMitAnimation/tasks.png");
    private static final Image PIN_IMAGE = new Image("app/test/dragNdropMitAnimation/pin.png");
